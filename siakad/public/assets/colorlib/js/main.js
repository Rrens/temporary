(function ($) {
    ...
    form.steps({
        ...
        onFinished: function (event, currentIndex) {
            alert("Data Berhasil di tambahkanw");
    ...
    $("#gender")
        .parent()
        .append('<ul class="list-item" id="newgender" name="gender"></ul>');
    ...
    $("#country")
        .parent()
        .append('<ul class="list-item" id="newcountry" name="country"></ul>');
    ...
    $("#payment_type")
        .parent()
        .append(
            '<ul  class="list-item" id="newpayment_type" name="payment_type"></ul>'
        );
    $("#payment_type option").each(function () {
        $("#newpayment_type").append(
            '<li value="' + $(this).val() + '">' + $(this).text() + "</li>"
        );
    });
    $("#payment_type").remove();
